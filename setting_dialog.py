...
class Ui_setting_dialog(object):
    def setupUi(self, setting_dialog):
        ...
        self.page.setMaximumSize(QSize(16777215, 360))
        ...
        self.lineEdit_random_text = QLineEdit(self.page)
        self.lineEdit_random_text.setObjectName(u"lineEdit_random_text")
        self.lineEdit_random_text.setEnabled(False)

        self.gridLayout.addWidget(self.lineEdit_random_text, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_password, 11, 0, 1, 1)
        ...
        self.pushButton_random_text = QPushButton(self.page)
        self.pushButton_random_text.setObjectName(u"pushButton_random_text")

        self.gridLayout.addWidget(self.pushButton_random_text, 9, 1, 1, 1)
        ...
        self.pushButton_change_password = QPushButton(self.page)
        self.pushButton_change_password.setObjectName(u"pushButton_change_password")

        self.gridLayout.addWidget(self.pushButton_change_password, 11, 1, 1, 1)
