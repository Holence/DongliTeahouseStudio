...
class Ui_password_check_window(object):
    def setupUi(self, password_check_window):
        ...
        password_check_window.resize(279, 191)
        icon = QIcon()
...
"}")
        ...
        self.title_frame.setGeometry(QRect(0, 0, 271, 51))
...
"}")
        ...
        self.buttonBox.setGeometry(QRect(89, 140, 150, 32))
        self.buttonBox.setOrientation(Qt.Horizontal)
        self.buttonBox.setStandardButtons(QDialogButtonBox.Cancel|QDialogButtonBox.Ok)
        self.lineEdit = QLineEdit(self.centralwidget)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(57, 61, 181, 29))
        self.lineEdit.setEchoMode(QLineEdit.Password)
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(61, 100, 175, 31))
        font1 = QFont()
    ...
    def retranslateUi(self, password_check_window):
        ...
        self.label.setText(QCoreApplication.translate("password_check_window", u"Nice Day!", None))
